...
This application will create and expose a resource collection at "/cities" using Spring Data REST. We'll continue building upon the Spring Boot application we build in Lab 1.  The first stereotype we will need is the domain model itself, which is `City`.
...
Date: Tue, 19 Feb 2019 00:56:16 GMT
...
Content-Type: application/hal+json;charset=UTF-8
Transfer-Encoding: chunked
Date: Tue, 19 Feb 2019 01:33:20 GMT
...
Content-Type: application/hal+json;charset=UTF-8
Transfer-Encoding: chunked
Date: Tue, 19 Feb 2019 01:39:42 GMT
...
Content-Type: application/hal+json;charset=UTF-8
Transfer-Encoding: chunked
Date: Tue, 19 Feb 2019 01:38:52 GMT
...
Showing health and status for app cloud-native-spring in org mordor / space development as shgupta@pivotal.io...

name:              cloud-native-spring
requested state:   started
routes:            cloud-native-spring-reliable-mouse.cfapps.io
last uploaded:     Mon 18 Feb 19:44:40 CST 2019
stack:             cflinuxfs3
...
#0   running   2019-02-19T01:45:15Z   0.4%   321.2M of 1G   168.6M of 1G
